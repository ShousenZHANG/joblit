          ...
          return (
            <motion.li
              ...
              className={
                ...
                (tier.featured
                  ? "border-brand-emerald/40 bg-gradient-to-b from-brand-emerald-50/80 to-background shadow-[0_20px_40px_-12px_rgba(91,91,214,0.22)]"
              ...
              <motion.div
                ...
                style={{
                  background: tier.featured
                    ? "radial-gradient(120% 80% at 50% 0%, rgba(91,91,214,0.16), transparent 60%)"
                    : "radial-gradient(120% 80% at 50% 0%, rgba(91,91,214,0.12), transparent 55%)",
                  boxShadow: tier.featured
                    ? "0 36px 72px -28px rgba(91,91,214,0.38)"
                    : "0 28px 56px -24px rgba(91,91,214,0.28)",
                }}
              />
