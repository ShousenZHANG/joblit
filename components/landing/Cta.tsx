...
export function Cta() {
  ...
  return (
    <motion.section
      ...
      variants={fadeUp}
    >
      <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card px-8 py-16 text-center shadow-[0_30px_80px_-40px_rgba(0,113,227,0.30)] sm:px-16 sm:py-24">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_45%_at_50%_0%,rgba(43,138,239,0.16),transparent_65%)]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_55%_35%_at_15%_100%,rgba(0,113,227,0.10),transparent_60%)]"
        />
        <div
          aria-hidden
