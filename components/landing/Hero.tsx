  ...
  return (
    ...
    >
      ...
      >
        {t("titleLine1")}
        <br />
        <em className="font-serif italic text-brand-emerald-600">
          {t("titleItalic")}
        </em>
      </motion.h1>
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -inset-x-6 -bottom-8 -z-10 h-72 bg-[radial-gradient(ellipse_60%_50%_at_50%_0%,rgba(110,106,222,0.12),transparent_70%)]"
        />
                ...
                {JOB_ROWS.map((row, i) => (
                  <motion.li
                    ...
                    className={
                      ...
                      (i === activeRow
                        ? "border-l-brand-emerald-500 bg-brand-emerald-50/40 shadow-[0_12px_30px_-24px_rgba(91,91,214,0.55)]"
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <span className="flex items-center gap-1">
                        {i === activeRow && (
                          <span
                            aria-hidden
                            className="h-1.5 w-1.5 rounded-full bg-brand-emerald-500 shadow-[0_0_0_4px_rgba(110,106,222,0.14)]"
                          />
                        )}
                        <span
                          className={
