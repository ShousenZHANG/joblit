        ...
        <div className="mt-3 flex w-full flex-col items-center gap-2 border-t border-border/70 pt-3">
          <button
            ...
            className={cn(
              ...
              "shadow-[0_10px_24px_-14px_rgba(0,113,227,0.7)] transition-[transform,box-shadow,filter] duration-150 ease-out motion-reduce:transition-none",
              "hover:brightness-105 hover:shadow-[0_14px_28px_-14px_rgba(0,113,227,0.8)]",
              "active:scale-[0.97] motion-reduce:active:scale-100",
