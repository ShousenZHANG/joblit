...
export function JobsClient({
  ...
  const guideHighlightClass =
    "ring-2 ring-brand-emerald-500 ring-offset-2 ring-offset-background shadow-[0_0_0_4px_rgba(110,106,222,0.22)]";
      ...
      {activeError ? (
        ...
        <div
          ...
          className={cn(
            ...
            "lg:rounded-3xl lg:border-2 lg:border-border/50 lg:bg-background/85 lg:shadow-[0_18px_40px_-32px_rgba(15,23,42,0.3)] lg:hover:shadow-[0_24px_50px_-36px_rgba(91,91,214,0.22)]",
