...
function TailorReviewDialogBody({
  ...
  return (
    <>
      ...
      <div className="grid min-h-0 flex-1 gap-5 overflow-hidden bg-[radial-gradient(circle_at_6%_0%,rgba(113,113,122,0.09),transparent_28%),radial-gradient(circle_at_82%_8%,rgba(59,130,246,0.055),transparent_30%)] p-4 md:p-6 lg:grid-cols-2">
      ...
      <div className="flex shrink-0 flex-col gap-3 border-t border-slate-200/70 bg-white/90 px-5 py-4 shadow-[0_-18px_48px_-42px_rgba(15,23,42,0.55)] backdrop-blur-xl md:flex-row md:items-center md:justify-between md:px-7">
        ...
        <div className="flex flex-wrap justify-end gap-2.5">
          ...
          <Button
            ...
            className={cn(
              "h-10 rounded-full border border-brand-emerald-500 bg-brand-emerald-500 px-5 text-sm font-semibold text-white shadow-[0_14px_30px_-16px_rgba(113,113,122,0.85)] transition-all hover:-translate-y-px hover:border-brand-emerald-600 hover:bg-brand-emerald-600 hover:shadow-[0_18px_34px_-16px_rgba(113,113,122,0.95)] active:translate-y-0",
