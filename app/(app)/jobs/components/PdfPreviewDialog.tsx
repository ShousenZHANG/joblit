    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex h-full flex-col">
          <div className="flex h-11 items-center justify-between border-b border-border bg-card/90 px-3">
            ...
            <div className="flex items-center gap-2">
              {pdfPreview ? (
                <Button
                  ...
                  size="sm"
                  variant="outline"
                  className="h-9 rounded-xl border-border bg-card px-3 text-sm font-medium text-foreground/85 shadow-sm transition-all duration-200 hover:border-border hover:bg-muted/40 active:translate-y-[1px]"
                >
