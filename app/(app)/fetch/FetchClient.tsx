      ...
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <button
            ...
            className={cn(
              ...
              "hover:shadow-[0_8px_22px_-14px_rgba(0,113,227,0.45)]",
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-emerald-400/50 focus-visible:ring-offset-1",
              open
                ? "border-brand-emerald-300 bg-brand-emerald-50/40 shadow-[0_10px_28px_-14px_rgba(0,113,227,0.5)]"
        ...
        <DropdownMenuContent
          ...
          className={cn(
            ...
            "shadow-[0_24px_60px_-30px_rgba(15,23,42,0.5),0_8px_24px_-12px_rgba(0,113,227,0.16)]",
...
export function FetchClient() {
  ...
  const guideHighlightClass =
    "ring-2 ring-brand-emerald-400 ring-offset-2 ring-offset-white shadow-[0_0_0_4px_rgba(43,138,239,0.18)]";
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2" data-testid="fetch-actions">
          <Button
            onClick={onSubmit}
            disabled={isSubmitting || isRunning}
            className={`h-10 rounded-xl bg-gradient-to-r from-brand-emerald-500 to-brand-emerald-600 px-6 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:from-brand-emerald-600 hover:to-brand-emerald-700 hover:shadow-lg active:scale-[0.98] disabled:opacity-50 ${
