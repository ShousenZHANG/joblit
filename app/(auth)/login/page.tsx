  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 pb-16 pt-8 sm:px-10">
      ...
      <div className="relative z-[1] mx-auto flex min-h-[calc(100vh-8rem)] w-full max-w-5xl flex-col">
        ...
        >
          <div
            className="relative w-full max-w-md overflow-hidden rounded-3xl border border-border/60 bg-background/85 p-8 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_20px_42px_-18px_rgba(91,91,214,0.2)] backdrop-blur-sm sm:p-10"
