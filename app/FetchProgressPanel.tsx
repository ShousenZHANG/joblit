            ...
            <motion.circle
              ...
              stroke={
                status === "FAILED"
                  ...
                  : "var(--color-brand-emerald-500, #2b8aef)"
              }
              strokeWidth="3"
              strokeLinecap="round"
            ...
            <div className="space-y-1.5">
              <Progress
                ...
                indicatorClassName={cn(
                  "bg-gradient-to-r from-brand-emerald-500 to-brand-emerald-600 shadow-[0_0_10px_rgba(43,138,239,0.4)] transition-all duration-500 ease-out",
                  status === "FAILED" &&
